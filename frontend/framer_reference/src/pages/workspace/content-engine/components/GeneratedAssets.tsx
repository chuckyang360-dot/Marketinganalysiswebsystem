      ...
      {selectedImg !== null && (
        ...
        >
          {(() => {
            ...
            function handleDownload(url: string, id: number, label: string) {
...
/* ─── Prompts (Video only — image + video prompt) ─────────── */
...
/* ─── Clips ──────────────────────────────────────────────── */
// Clip preview images (mock covers for each clip segment)
const CLIP_COVERS = [
                  ...
                  <div className="flex items-center justify-between mt-auto pt-3" style={{ borderTop: "1px solid #EAEAEA" }}>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button
                        className="w-7 h-7 flex items-center justify-center rounded-lg cursor-pointer transition-all duration-150"
                        style={{
                          background: downloadingId === clip.id ? "rgba(16,185,129,0.08)" : "rgba(16,185,129,0.08)",
