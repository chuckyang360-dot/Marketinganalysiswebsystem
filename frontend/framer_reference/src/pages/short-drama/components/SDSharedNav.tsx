...
const STEPS = [
  { label: "产品输入", path: "/short-drama/step1", step: 1 },
  { label: "剧本大纲", path: "/short-drama/step2", step: 2 },
  { label: "角色场景", path: "/short-drama/step3", step: 3 },
    ...
    >
      <div className="mx-auto px-6 lg:px-10 flex items-center justify-between h-14" style={{ maxWidth: "1440px" }}>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            onClick={() => navigate("/")}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[12.5px] cursor-pointer transition-all duration-200 whitespace-nowrap"
          ...
          >
            <i className="ri-home-4-line text-[13px]" />
