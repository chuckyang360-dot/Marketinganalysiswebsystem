...
export const MOCK_CONTENT_ENGINE = {
  ...
  breakdown: {
    hook: {
      ...
      explanation: "用「时间成本」暗示可信度，「才是真相」暗示市面上都是错的——强烈激发用户的好奇心和打假欲望。",
    },
    structure: [
    ...
    emotion: {
      ...
      intensity: 82,
      description: "通过「30天」和「真相」制造权威感，同时用对比让用户担心自己选错。",
    },
    visual: {
      composition: "快剪 + 产品特写交替",
      scene: "室内工作台 / 白底对比拍摄",
      styleTag: ["快节奏", "干净背景", "数字字幕", "进度条"],
      description: "黑白背景切换强化对比感，3秒一切镜节奏契合TikTok用户注意力。",
    },
    performance: {
      likes: "24.7K",
      comments: "1,892",
