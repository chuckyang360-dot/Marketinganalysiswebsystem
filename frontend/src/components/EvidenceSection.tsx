...
export function EvidenceSection({ data }: Props) {
  const { reddit_analysis, seo_analysis, x_analysis } = data;
    ...
    <div className="space-y-6">
      ...
      <div id="section-reddit-evidence" className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-sm text-gray-500 ml-2">
            {reddit_analysis.sentiment.positive + reddit_analysis.sentiment.negative + reddit_analysis.sentiment.neutral} 条讨论
          </span>
        </div>
      ...
      <div id="section-seo-evidence" className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-sm text-gray-500 ml-2">
            {seo_analysis.sentiment.positive + seo_analysis.sentiment.negative + seo_analysis.sentiment.neutral} 条内容
          </span>
        </div>
