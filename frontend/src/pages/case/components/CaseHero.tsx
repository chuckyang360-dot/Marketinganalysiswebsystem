...
export default function CaseHero() {
  ...
  return (
    <section
      ...
      style={{ background: "#ffffff", minHeight: "60vh", display: "flex", alignItems: "center", paddingTop: "96px" }}
    >
      <div
      ...
      <div className="relative z-10 w-full mx-auto px-6 lg:px-10" style={{ maxWidth: "1100px" }}>
        <div ref={ref} style={{ opacity: 0, transform: "translateY(28px)", transition: "opacity 0.75s ease, transform 0.75s ease" }}>
          ...
          <h1
            className="font-extrabold leading-[1.08] tracking-[-0.035em] mb-7"
          ...
          >
            <Eye size={15} color="#7B61FF" strokeWidth={2} />
          ...
          <div className="flex flex-wrap items-center gap-8 mt-12">
            {[
              { value: "3×", label: "平均 CTR 提升" },
              { value: "5×", label: "内容产出效率" },
              { value: "100%", label: "问题→结果闭环" },
            ].map((stat) => (
              <div key={stat.label}>
                <div
