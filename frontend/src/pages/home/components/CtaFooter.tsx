    ...
    <>
      ...
      <section id="pricing" className="relative py-24 lg:py-32 overflow-hidden" style={{ background: "#ffffff", borderTop: "1px solid #EAEAEA" }}>
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-7">
            ...
            >
              <i className="ri-dashboard-line text-[15px]" />
              进入工作台
            </button>
            <button
      ...
      <footer style={{ background: "#F7F8FA", borderTop: "1px solid #EAEAEA" }}>
        <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-14">
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2.5 mb-5">
                <div className="w-8 h-8 flex items-center justify-center rounded-xl" style={{ background: "linear-gradient(135deg, #7B61FF, #5B8CFF)" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4" style={{ borderTop: "1px solid #EAEAEA", paddingTop: "28px" }}>
