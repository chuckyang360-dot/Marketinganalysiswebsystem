    ...
    <section className="w-full py-28" style={{ background: "#F7F8FA", borderTop: "1px solid #EAEAEA" }}>
      <div className="mx-auto px-6 lg:px-10" style={{ maxWidth: "1100px" }}>
        <div ref={ref} style={{ opacity: 0, transform: "translateY(24px)", transition: "opacity 0.7s ease, transform 0.7s ease" }}>
          ...
          <h2
            className="font-extrabold leading-[1.12] tracking-[-0.03em] mb-14"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            <div className="rounded-2xl p-8 flex flex-col gap-6" style={{ background: "#ffffff", border: "1px solid #EAEAEA" }}>
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 flex items-center justify-center rounded-xl shrink-0" style={{ background: "linear-gradient(135deg, #7B61FF, #5B8CFF)" }}>
            ...
            <div className="rounded-2xl p-8 flex flex-col gap-6" style={{ background: "rgba(123,97,255,0.04)", border: "1px solid rgba(123,97,255,0.18)" }}>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <a
                    href={`mailto:${EMAIL}`}
                    className="text-[15px] font-semibold cursor-pointer transition-colors duration-200 hover:underline whitespace-nowrap"
                    style={{ color: "#7B61FF" }}
                  >
                    {EMAIL}
                  </a>
                  <button
                    ...
                    style={{
                      background: copied ? "rgba(5,150,105,0.08)" : "#ffffff",
                      border: `1px solid ${copied ? "rgba(5,150,105,0.25)" : "#EAEAEA"}`,
                      color: copied ? "#059669" : "#888888",
                    }}
                  >
