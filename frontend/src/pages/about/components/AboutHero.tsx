...
export default function AboutHero() {
  ...
  return (
    <section
      ...
      style={{ background: "#ffffff", minHeight: "72vh", display: "flex", alignItems: "center", paddingTop: "96px" }}
    >
      ...
      <div className="relative z-10 w-full mx-auto px-6 lg:px-10" style={{ maxWidth: "960px" }}>
        <div ref={ref} style={{ opacity: 0, transform: "translateY(28px)", transition: "opacity 0.75s ease, transform 0.75s ease" }}>
          <div className="mb-8">
            <span
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-[11.5px] font-medium"
          ...
          <h1
            className="font-extrabold leading-[1.08] tracking-[-0.035em] mb-8"
          ...
          <div className="inline-flex items-center gap-3 px-5 py-3 rounded-xl" style={{ border: "1px solid rgba(123,97,255,0.18)", background: "rgba(123,97,255,0.05)" }}>
